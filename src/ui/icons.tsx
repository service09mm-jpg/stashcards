/**
 * Іконки намальовані тут, а не взяті з бібліотеки, і причина суто практична:
 * їх рівно вісім. Будь-який пакет іконок важив би більше за весь цей файл, а
 * застосунок має цілком поміщатися в кеш і відкриватися миттєво.
 */
